...
const (
	USER_FORWARD Action = iota
	USER_BACKWARD Action = iota
	USER_LEFT Action = iota
	USER_RIGHT Action = iota
...
func NewInputManager() *InputManager {
	actionToKeyMap := map[Action]glfw.Key{
		USER_FORWARD: glfw.KeyW,
		USER_BACKWARD: glfw.KeyS,
		USER_LEFT: glfw.KeyA,
		USER_RIGHT: glfw.KeyD,
